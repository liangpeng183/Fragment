...
public class MsAdapter extends RecyclerView.Adapter<MsAdapter.ViewHolder>{
    ...
    public MsAdapter(Context context, List<Food> foodList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycleview_ms,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        viewHolder.tv_desc.setText(foodList.get(position).getFoodDesc());
